...
const directoryPath = "/Users/peetstander/Projects/empire/.demo/components" // Change this to your directory path
...
const renameFiles = () => {
  fs.readdir(directoryPath, (err, files) => {
    ...
    files.forEach((file) => {
      ...
      if (file.startsWith("Demo") && file.endsWith(".vue")) {
        // New file name without 'Demo'
        const newFileName = file.replace(/^Demo/, "")
