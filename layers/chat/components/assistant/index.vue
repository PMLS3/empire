...
<template>
  <div class="text-muted-800 h-screen antialiased">
    ...
    <!--Wrapper-->
    <div
      class="relative z-20 flex h-[calc(100dvh_-_84px)] w-full flex-row overflow-x-hidden"
    >
        ...
        >
          <div class="relative flex h-full flex-col">
            ...
            <div class="absolute inset-x-0 bottom-4 w-full px-4">
              ...
              <ChatConversationCompose v-if="isCompose" />
              <ChatConversationComposeTextarea v-else />
