...
const isPersonal = computed(() => {
  return route.path.match('^/publishing/book/settings$')
})

const isBook = computed(() => {
  return route.path.match('^/publishing/book/settings/book$')
})

const isResearch = computed(() => {
  return route.path.startsWith('/publishing/book/settings/research')
})
