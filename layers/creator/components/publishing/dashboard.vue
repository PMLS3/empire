...
const { selectResearchCategory } = useResearch()

const { sendContextMessage } = useChat()

onMounted(() => {
  sendContextMessage('We are in the publishing dashboard')
})
    ...
    <div class="mb-8 flex flex-col justify-between md:flex-row md:items-center">
      ...
      >
        <BaseButton
          color="primary"
          class="w-32"
          @click="$router.push('/publishing/book/create')"
        >
          <span>Create Book Step</span>
        </BaseButton>
      </div>
    </div>
    <!-- Grid -->
      ...
      <div class="ltablet:col-span-8 col-span-12 lg:col-span-8">
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 sm:col-span-6">
            ...
            <!-- List -->
            <div class="no-scrollbar h-96 space-y-2 overflow-auto">
              <!-- List item -->
              <PublishingCategories @select-category="selectResearchCategory" />
            </div>
          </div>
          <!-- Grid item -->
          <div class="col-span-12 sm:col-span-6">
            <div class="my-4">
              <BaseHeading
                ...
                class="text-muted-800 dark:text-white"
              >
                <span>Latest Researched</span>
              </BaseHeading>
              <BaseParagraph size="sm">
                <span class="text-muted-500">
                  Check out the latest researched
                </span>
              </BaseParagraph>
            </div>
            <!-- List -->
            <div class="no-scrollbar h-96 space-y-2 overflow-auto">
              <!-- List item -->
              <PublishingCategoriesResearched />
            </div>
          </div>
        </div>
      </div>
