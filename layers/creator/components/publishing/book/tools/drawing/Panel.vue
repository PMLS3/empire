...
type BrushType = 'pencil' | 'marker' | 'airbrush'

const brushTypes = [
  { value: 'pencil' as BrushType, label: 'Pencil', icon: 'i-heroicons-pencil' },
  { value: 'marker' as BrushType, label: 'Marker', icon: 'i-heroicons-paint-brush' },
  { value: 'airbrush' as BrushType, label: 'Airbrush', icon: 'i-heroicons-sparkles' }
]
